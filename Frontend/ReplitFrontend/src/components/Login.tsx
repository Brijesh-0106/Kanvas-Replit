  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <h2 className="text-[#c3c2b7] text-2xl font-bold">Welcome back</h2>
      ...
      <form onSubmit={handleSubmit(loginViaEmail)}>
        ...
        <button className="w-full bg-blue-600 cursor-pointer hover:bg-blue-500 text-[#c3c2b7] hover:text-white py-3 rounded-xl text-sm font-medium transition-all">
          Log in
        </button>
      </form>
